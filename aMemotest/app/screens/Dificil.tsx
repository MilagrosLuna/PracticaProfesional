...
export default function Dificil() {
  ...
  const animalImages = [
    require('../../assets/frutas/arandanos.png'),
    require('../../assets/frutas/banana.png'),
    require('../../assets/frutas/cereza.png'),
    require('../../assets/frutas/frutilla.png'),
    require('../../assets/frutas/kiwi.png'),
    require('../../assets/frutas/manzana.png'),
    require('../../assets/frutas/naranja.png'),
    require('../../assets/frutas/sandia.png'),
    require('../../assets/frutas/arandanos.png'),
    require('../../assets/frutas/banana.png'),
    require('../../assets/frutas/cereza.png'),
    require('../../assets/frutas/frutilla.png'),
    ...
    <View style={styles.container}>
      ...
      {matchedPairs.length === shuffledImages.length && (
        <TouchableOpacity
          ...
          onPress={restartGame}>
          <Icon name="repeat" size={40} color="black"></Icon>
        </TouchableOpacity>
      )}
    </View>
  );
